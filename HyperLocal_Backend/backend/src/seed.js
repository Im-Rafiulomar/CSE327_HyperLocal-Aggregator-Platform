...
import { Seller, Category, Product, User, Order } from "./models.js";

const sellers = [
  {sellerId:"s1",name:"Dhanmondi Electronics",nameBn:"ধানমন্ডি ইলেকট্রনিক্স",area:"Dhanmondi, Dhaka",rating:4.7,isLocal:true,verified:true,since:"2019",responseTime:"~12 min"},
  {sellerId:"s2",name:"TechHub BD Online",nameBn:"টেকহাব বিডি",area:"Nationwide",rating:4.5,isLocal:false,verified:true,since:"2017",responseTime:"~1 hr"},
  {sellerId:"s3",name:"Uttara Gadget Corner",nameBn:"উত্তরা গ্যাজেট কর্নার",area:"Uttara, Dhaka",rating:4.3,isLocal:true,verified:false,since:"2021",responseTime:"~30 min"},
  {sellerId:"s4",name:"Chattogram Fresh Mart",nameBn:"চট্টগ্রাম ফ্রেশ মার্ট",area:"Agrabad, Chattogram",rating:4.8,isLocal:true,verified:true,since:"2020",responseTime:"~8 min"}
];

const categories = [
  {categoryId:"electronics",name:"Electronics",nameBn:"ইলেকট্রনিক্স",emoji:"📱"},
  {categoryId:"grocery",name:"Grocery",nameBn:"মুদি",emoji:"🥬"},
  {categoryId:"fashion",name:"Fashion",nameBn:"ফ্যাশন",emoji:"👕"},
  {categoryId:"home",name:"Home & Living",nameBn:"গৃহসজ্জা",emoji:"🛋️"},
  {categoryId:"beauty",name:"Beauty",nameBn:"প্রসাধনী",emoji:"💄"},
  {categoryId:"sports",name:"Sports",nameBn:"খেলাধুলা",emoji:"🏏"}
];

const products = [
  {
    productId:"p1",name:"Wireless Noise-Cancelling Headphones",nameBn:"ওয়্যারলেস নয়েজ ক্যান্সেলিং হেডফোন",brand:"SoundPeak",category:"electronics",
    image:"linear-gradient(135deg,#1f4d46,#0f2f36)",emoji:"🎧",price:6450,oldPrice:8900,rating:4.6,reviewCount:1284,
    ...
    offers:[{sellerId:"s1",price:6450,delivery:"Same day in Dhanmondi",stock:7},{sellerId:"s2",price:6299,delivery:"2-3 days nationwide",stock:45},{sellerId:"s3",price:6690,delivery:"Next day in Uttara",stock:3}],
    reviews:[
  ...
  {
    productId:"p2",name:"Smart Fitness Band 6",nameBn:"স্মার্ট ফিটনেস ব্যান্ড ৬",brand:"PulseFit",category:"electronics",
    image:"linear-gradient(135deg,#2c3e70,#14203f)",emoji:"⌚",price:2890,oldPrice:3500,rating:4.3,reviewCount:642,
    ...
    offers:[{sellerId:"s2",price:2890,delivery:"2-3 days nationwide",stock:120},{sellerId:"s3",price:2950,delivery:"Next day in Uttara",stock:12}],
    reviews:[
  ...
  {
    productId:"p3",name:"Premium Basmati Rice 5kg",nameBn:"প্রিমিয়াম বাসমতি চাল ৫ কেজি",brand:"Golden Field",category:"grocery",
    image:"linear-gradient(135deg,#6b5a2e,#3a2f16)",emoji:"🍚",price:890,rating:4.8,reviewCount:310,
    ...
    offers:[{sellerId:"s4",price:890,delivery:"Same day in Chattogram",stock:60},{sellerId:"s1",price:935,delivery:"Same day in Dhanmondi",stock:22}],
    reviews:[
  ...
  {
    productId:"p4",name:"Handloom Cotton Panjabi",nameBn:"হ্যান্ডলুম কটন পাঞ্জাবি",brand:"Tantu",category:"fashion",
    image:"linear-gradient(135deg,#5c3a63,#2b1a32)",emoji:"👘",price:1750,oldPrice:2200,rating:4.5,reviewCount:188,
    ...
    offers:[{sellerId:"s1",price:1750,delivery:"Same day in Dhanmondi",stock:15},{sellerId:"s2",price:1820,delivery:"2-3 days nationwide",stock:40}],
    reviews:[
  ...
  {
    productId:"p5",name:"Ceramic Cookware Set (5 pcs)",nameBn:"সিরামিক কুকওয়্যার সেট (৫ পিস)",brand:"HomeCraft",category:"home",
    image:"linear-gradient(135deg,#7a4436,#39201a)",emoji:"🍳",price:4200,oldPrice:5400,rating:4.2,reviewCount:96,
    ...
    offers:[{sellerId:"s4",price:4200,delivery:"Same day in Chattogram",stock:9},{sellerId:"s2",price:4390,delivery:"2-3 days nationwide",stock:30}],
    reviews:[
  ...
  {
    productId:"p6",name:"Vitamin C Brightening Serum",nameBn:"ভিটামিন সি ব্রাইটেনিং সিরাম",brand:"GlowLab",category:"beauty",
    image:"linear-gradient(135deg,#8a6d1f,#3f3110)",emoji:"🧴",price:1290,rating:4.4,reviewCount:452,
    ...
    offers:[{sellerId:"s2",price:1290,delivery:"2-3 days nationwide",stock:200},{sellerId:"s3",price:1350,delivery:"Next day in Uttara",stock:25}],
    reviews:[
  ...
  {
    productId:"p7",name:"Tape Ball Cricket Bat",nameBn:"টেপ বল ক্রিকেট ব্যাট",brand:"Rangpur Sports",category:"sports",
    image:"linear-gradient(135deg,#3d5a2c,#1c2b14)",emoji:"🏏",price:1450,oldPrice:1800,rating:4.6,reviewCount:210,
    ...
    offers:[{sellerId:"s3",price:1450,delivery:"Next day in Uttara",stock:18},{sellerId:"s1",price:1499,delivery:"Same day in Dhanmondi",stock:6}],
    reviews:[{id:"r1",user:"Sajid K.",rating:5,text:"Great pickup for street cricket, sweet spot is wide.",date:"3 days ago"}],
  ...
  {
    productId:"p8",name:"Portable Blender 400ml",nameBn:"পোর্টেবল ব্লেন্ডার ৪০০ মিলি",brand:"MixGo",category:"home",
    image:"linear-gradient(135deg,#2f5f6b,#13303a)",emoji:"🥤",price:1690,rating:4.1,reviewCount:134,
    ...
    offers:[{sellerId:"s2",price:1690,delivery:"2-3 days nationwide",stock:80},{sellerId:"s4",price:1740,delivery:"Same day in Chattogram",stock:11}],
    reviews:[{id:"r1",user:"Priya D.",rating:4,text:"Handles soft fruit well, struggles with ice.",date:"1 week ago"}],
...
const demoOrders = [
  {orderId:"HL-2291",date:"29 Jul 2026",items:[{productId:"p1",qty:1,price:6450}],total:6450,payment:"bKash",status:2,seller:"s1"},
  {orderId:"HL-2264",date:"22 Jul 2026",items:[{productId:"p3",qty:2,price:890},{productId:"p8",qty:1,price:1740}],total:3520,payment:"Cash on Delivery",status:3,seller:"s4"}
];

async function seed() {
  await connectDB(process.env.MONGODB_URI);
  await Promise.all([Seller.deleteMany({}),Category.deleteMany({}),Product.deleteMany({})]);
  await Seller.insertMany(sellers);
  await Category.insertMany(categories);
  await Product.insertMany(products);
  let demo = await User.findOne({email:"ayesha.r@example.com"});
  if (!demo) {
    demo = await User.create({userId:"u-demo",name:"Ayesha Rahman",email:"ayesha.r@example.com",role:"customer",coins:1240,wishlist:["p1","p6"],viewed:["p1","p7"],cart:[{productId:"p3",sellerId:"s4",qty:1}],phone:"+880 1712 345678",area:"Dhanmondi, Dhaka"});
  } else {
    demo.coins=1240; demo.wishlist=["p1","p6"]; demo.viewed=["p1","p7"]; demo.cart=[{productId:"p3",sellerId:"s4",qty:1}]; await demo.save();
  }
  await Order.deleteMany({userId:"u-demo"});
  await Order.insertMany(demoOrders.map(o=>({...o,userId:"u-demo"})));
  console.log("HyperLocal seed complete: 4 sellers, 6 categories, 8 products, demo account and demo orders.");
  process.exit(0);
}
